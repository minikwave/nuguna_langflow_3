...
def render_dashboard():
    st.title("Dashboard")
    st.markdown("**Note**: [View System Metrics in Grafana](http://localhost:3000)")
    ...
    if st.button("Submit"):
        ...
        try:
            ...
            st.error(f"Error handling prompt: {e}")
...
#     st.markdown(
#         """
#         **Note**: [View System Metrics in Grafana](http://localhost:3000)
#         """
#     )
